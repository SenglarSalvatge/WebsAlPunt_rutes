...
class Post(models.Model):
    ...
    puntuacions = models.ManyToManyField(Perfil, through='social.Puntuacio', related_name="puntuacioPost")
    comentaris = models.ManyToManyField(Perfil, through='social.Comentari', related_name="comentariPost")
